...
map(e, t, n) { let r; let i; let o = 0; const a = []; if (p(e)) for (r = e.length; o < r; o++)(i = t(e[o], o, n)) != null && a.push(i); else for (o in e)(i = t(e[o], o, n)) != null && a.push(i); return g(a); },
guid: 1,
support: y
}), typeof Symbol === 'function' && (S.fn[Symbol.iterator] = t[Symbol.iterator]), S.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '), function(e, t) { n['[object ' + t + ']'] = t.toLowerCase(); }); const d = (function(n) {
...
catch(e) { H = { apply: t.length ? function(e, t) { L.apply(e, O.call(t)); } : function(e, t) { let n = e.length; let r = 0; while (e[n++] = t[r++]);e.length = n - 1; } }; } function se(t, e, n, r) {
 let i; let o; let a; let s; let u; let l; let c; let f = e && e.ownerDocument; const p = e ? e.nodeType : 9; if (n = n || [], typeof t !== 'string' || !t || p !== 1 && p !== 9 && p !== 11) return n; if (!r && (T(e), e = e || C, E)) {
 if (p !== 11 && (u = Z.exec(t))) {
if (i = u[1]) {
...
CLASS(e) { let t = m[e + ' ']; return t || (t = new RegExp('(^|' + M + ')' + e + '(' + M + '|$)')) && m(e, function(e) { return t.test(typeof e.className === 'string' && e.className || typeof e.getAttribute !== 'undefined' && e.getAttribute('class') || ''); }); },
...
PSEUDO(e, o) { let t; const a = b.pseudos[e] || b.setFilters[e.toLowerCase()] || se.error('unsupported pseudo: ' + e); return a[S] ? a(o) : a.length > 1 ? (t = [ e, e, '', o ], b.setFilters.hasOwnProperty(e.toLowerCase()) ? le(function(e, t) { let n; const r = a(e, o); let i = r.length; while (i--)e[n = P(e, r[i])] = !(t[n] = r[i]); }) : function(e) { return a(e, 0, t); }) : a; }
},
...
}).pseudos.nth = b.pseudos.eq, { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })b.pseudos[e] = de(e); for (e in { submit: !0, reset: !0 })b.pseudos[e] = he(e); function me() {} function xe(e) { for (var t = 0, n = e.length, r = ''; t < n; t++)r += e[t].value; return r; } function be(s, e, t) {
 const u = e.dir; const l = e.next; const c = l || u; const f = t && c === 'parentNode'; const p = r++; return e.first ? function(e, t, n) { while (e = e[u]) if (e.nodeType === 1 || f) return s(e, t, n); return !1; } : function(e, t, n) {
 let r; let i; let o; const a = [ k, p ]; if (n) { while (e = e[u]) if ((e.nodeType === 1 || f) && s(e, t, n)) return !0; }
...
pipe() { let i = arguments; return S.Deferred(function(r) { S.each(o, function(e, t) { const n = m(i[t[4]]) && i[t[4]]; s[t[1]](function() { const e = n && n.apply(this, arguments); e && m(e.promise) ? e.promise().progress(r.notify).done(r.resolve).fail(r.reject) : r[t[0] + 'With'](this, n ? [ e ] : arguments); }); }), i = null; }).promise(); },
then(t, n, r) {
 let u = 0; function l(i, o, a, s) {
 return function() {
 let n = this; let r = arguments; const e = function() { let e; let t; if (!(i < u)) { if ((e = a.apply(n, r)) === o.promise()) throw new TypeError('Thenable self-resolution'); t = e && (typeof e === 'object' || typeof e === 'function') && e.then, m(t) ? s ? t.call(e, l(u, o, R, s), l(u, o, M, s)) : (u++, t.call(e, l(u, o, R, s), l(u, o, M, s), l(u, o, R, o.notifyWith))) : (a !== R && (n = void 0, r = [ e ]), (s || o.resolveWith)(n, r)); } }; var t = s ? e : function() {
 try { e(); }
...
}; var s = {}; return S.each(o, function(e, t) { const n = t[2]; const r = t[5]; a[t[1]] = n.add, r && n.add(function() { i = r; }, o[3 - e][2].disable, o[3 - e][3].disable, o[0][2].lock, o[0][3].lock), n.add(t[3].fire), s[t[0]] = function() { return s[t[0] + 'With'](this === s ? void 0 : this, arguments), this; }, s[t[0] + 'With'] = n.fireWith; }), a.promise(s), e && e.call(s, s), s;
},
...
}); const W = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/; S.Deferred.exceptionHook = function(e, t) { C.console && C.console.warn && e && W.test(e.name) && C.console.warn('jQuery.Deferred exception: ' + e.message, e.stack, t); }, S.readyException = function(e) { C.setTimeout(function() { throw e; }); }; const F = S.Deferred(); function B() { E.removeEventListener('DOMContentLoaded', B), C.removeEventListener('load', B), S.ready(); }S.fn.ready = function(e) { return F.then(e).catch(function(e) { S.readyException(e); }), this; }, S.extend({ isReady: !1, readyWait: 1, ready(e) { (!0 === e ? --S.readyWait : S.isReady) || (S.isReady = !0) !== e && --S.readyWait > 0 || F.resolveWith(E, [ S ]); } }), S.ready.then = F.then, E.readyState === 'complete' || E.readyState !== 'loading' && !E.documentElement.doScroll ? C.setTimeout(S.ready) : (E.addEventListener('DOMContentLoaded', B), C.addEventListener('load', B)); var $ = function(e, t, n, r, i, o, a) { let s = 0; const u = e.length; let l = n == null; if (w(n) === 'object') for (s in i = !0, n)$(e, t, s, n[s], !0, o, a); else if (void 0 !== r && (i = !0, m(r) || (a = !0), l && (a ? (t.call(e, r), t = null) : (l = t, t = function(e, t, n) { return l.call(S(e), n); })), t)) for (;s < u; s++)t(e[s], n, a ? r : r.call(e[s], s, t(e[s], n))); return i ? e : l ? t.call(e) : u ? t(e[0], n) : o; }; const _ = /^-ms-/; const z = /-([a-z])/g; function U(e, t) { return t.toUpperCase(); } function X(e) { return e.replace(_, 'ms-').replace(z, U); } const V = function(e) { return e.nodeType === 1 || e.nodeType === 9 || !+e.nodeType; }; function G() { this.expando = S.expando + G.uid++; }G.uid = 1, G.prototype = { cache(e) { let t = e[this.expando]; return t || (t = {}, V(e) && (e.nodeType ? e[this.expando] = t : Object.defineProperty(e, this.expando, { value: t, configurable: !0 }))), t; }, set(e, t, n) { let r; const i = this.cache(e); if (typeof t === 'string')i[X(t)] = n; else for (r in t)i[X(r)] = t[r]; return i; }, get(e, t) { return void 0 === t ? this.cache(e) : e[this.expando] && e[this.expando][X(t)]; }, access(e, t, n) { return void 0 === t || t && typeof t === 'string' && void 0 === n ? this.get(e, t) : (this.set(e, t, n), void 0 !== n ? n : t); }, remove(e, t) { let n; const r = e[this.expando]; if (void 0 !== r) { if (void 0 !== t) { n = (t = Array.isArray(t) ? t.map(X) : (t = X(t)) in r ? [ t ] : t.match(P) || []).length; while (n--) delete r[t[n]]; }(void 0 === t || S.isEmptyObject(r)) && (e.nodeType ? e[this.expando] = void 0 : delete e[this.expando]); } }, hasData(e) { const t = e[this.expando]; return void 0 !== t && !S.isEmptyObject(t); } }; const Y = new G(); const Q = new G(); const J = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/; const K = /[A-Z]/g; function Z(e, t, n) {
...
} const be = /^key/; const we = /^(?:mouse|pointer|contextmenu|drag|drop)|click/; const Te = /^([^.]*)(?:\.(.+)|)/; function Ce() { return !0; } function Ee() { return !1; } function Se(e, t) {
 return e === (function() {
 try { return E.activeElement; }
catch(e) {}
}()) == (t === 'focus');
} function ke(e, t, n, r, i, o) { let a; let s; if (typeof t === 'object') { for (s in typeof n !== 'string' && (r = r || n, n = void 0), t)ke(e, s, n, r, t[s], o); return e; } if (r == null && i == null ? (i = n, r = n = void 0) : i == null && (typeof n === 'string' ? (i = r, r = void 0) : (i = r, r = n, n = void 0)), !1 === i)i = Ee; else if (!i) return e; return o === 1 && (a = i, (i = function(e) { return S().off(e), a.apply(this, arguments); }).guid = a.guid || (a.guid = S.guid++)), e.each(function() { S.event.add(this, t, i, r, n); }); } function Ae(e, i, o) {
 o ? (Y.set(e, i, !1), S.event.add(e, i, {
 namespace: !1,
handler(e) {
 let t; let n; let r = Y.get(this, i); if (1 & e.isTrigger && this[i]) { if (r.length)(S.event.special[i] || {}).delegateType && e.stopPropagation(); else if (r = s.call(arguments), Y.set(this, i, r), t = o(this, i), this[i](), r !== (n = Y.get(this, i)) || t ? Y.set(this, i, !1) : n = {}, r !== n) return e.stopImmediatePropagation(), e.preventDefault(), n.value; }
...
remove(e, t, n, r, i) {
 let o; let a; let s; let u; let l; let c; let f; let p; let d; let h; let g; const v = Y.hasData(e) && Y.get(e); if (v && (u = v.events)) {
...
addProp(t, e) { Object.defineProperty(S.Event.prototype, t, { enumerable: !0, configurable: !0, get: m(e) ? function() { if (this.originalEvent) return e(this.originalEvent); } : function() { if (this.originalEvent) return this.originalEvent[t]; }, set(e) { Object.defineProperty(this, t, { enumerable: !0, configurable: !0, writable: !0, value: e }); } }); },
...
html(e) {
 ...
 let t = this[0] || {}; let n = 0; const r = this.length; if (void 0 === e && t.nodeType === 1) return t.innerHTML; if (typeof e === 'string' && !Ne.test(e) && !ge[(de.exec(e) || [ '', '' ])[1].toLowerCase()]) {
