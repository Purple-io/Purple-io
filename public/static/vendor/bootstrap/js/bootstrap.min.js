/* !
  ...
  */
!(function(t, e) { typeof exports === 'object' && typeof module !== 'undefined' ? e(exports, require('jquery'), require('popper.js')) : typeof define === 'function' && define.amd ? define([ 'exports', 'jquery', 'popper.js' ], e) : e((t = typeof globalThis !== 'undefined' ? globalThis : t || self).bootstrap = {}, t.jQuery, t.Popper); }(this, function(t, e, n) {
 'use strict'; function i(t) { return t && typeof t === 'object' && 'default' in t ? t : { default: t }; } const o = i(e); const a = i(n); function s(t, e) { for (let n = 0; n < e.length; n++) { const i = e[n]; i.enumerable = i.enumerable || !1, i.configurable = !0, 'value' in i && (i.writable = !0), Object.defineProperty(t, i.key, i); } } function l(t, e, n) { return e && s(t.prototype, e), n && s(t, n), t; } function r() { return (r = Object.assign || function(t) { for (let e = 1; e < arguments.length; e++) { const n = arguments[e]; for (const i in n)Object.prototype.hasOwnProperty.call(n, i) && (t[i] = n[i]); } return t; }).apply(this, arguments); } function u(t) { const e = this; let n = !1; return o.default(this).one(d.TRANSITION_END, function() { n = !0; }), setTimeout(function() { n || d.triggerTransitionEnd(e); }, t), this; } var d = {
...
getTransitionDurationFromElement(t) { if (!t) return 0; let e = o.default(t).css('transition-duration'); let n = o.default(t).css('transition-delay'); const i = parseFloat(e); const a = parseFloat(n); return i || a ? (e = e.split(',')[0], n = n.split(',')[0], 1e3 * (parseFloat(e) + parseFloat(n))) : 0; },
reflow(t) { return t.offsetHeight; },
triggerTransitionEnd(t) { o.default(t).trigger('transitionend'); },
supportsTransitionEnd() { return Boolean('transitionend'); },
isElement(t) { return (t[0] || t).nodeType; },
typeCheckConfig(t, e, n) { for (const i in n) if (Object.prototype.hasOwnProperty.call(n, i)) { const o = n[i]; const a = e[i]; const s = a && d.isElement(a) ? 'element' : (l = a) === null || typeof l === 'undefined' ? '' + l : {}.toString.call(l).match(/\s([a-z]+)/i)[1].toLowerCase(); if (!new RegExp(o).test(s)) throw new Error(t.toUpperCase() + ': Option "' + i + '" provided type "' + s + '" but expected type "' + o + '".'); } let l; },
findShadowRoot(t) { if (!document.documentElement.attachShadow) return null; if (typeof t.getRootNode === 'function') { const e = t.getRootNode(); return e instanceof ShadowRoot ? e : null; } return t instanceof ShadowRoot ? t : t.parentNode ? d.findShadowRoot(t.parentNode) : null; },
jQueryDetection() { if (typeof o.default === 'undefined') throw new TypeError('Bootstrap\'s JavaScript requires jQuery. jQuery must be included before Bootstrap\'s JavaScript.'); const t = o.default.fn.jquery.split(' ')[0].split('.'); if (t[0] < 2 && t[1] < 9 || t[0] === 1 && t[1] === 9 && t[2] < 1 || t[0] >= 4) throw new Error('Bootstrap\'s JavaScript requires at least jQuery v1.9.1 but less than v4.0.0'); }
}; d.jQueryDetection(), o.default.fn.emulateTransitionEnd = u, o.default.event.special[d.TRANSITION_END] = { bindType: 'transitionend', delegateType: 'transitionend', handle(t) { if (o.default(t.target).is(this)) return t.handleObj.handler.apply(this, arguments); } }; const f = 'alert'; const c = o.default.fn[f]; const h = (function() {
 ...
 const n = o.default.Event('hide.bs.modal'); if (o.default(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
 this._isShown = !1; const i = o.default(this._element).hasClass('fade'); if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), o.default(document).off('focusin.bs.modal'), o.default(this._element).removeClass('show'), o.default(this._element).off('click.dismiss.bs.modal'), o.default(this._dialog).off('mousedown.dismiss.bs.modal'), i) { const a = d.getTransitionDurationFromElement(this._element); o.default(this._element).one(d.TRANSITION_END, function(t) { return e._hideModal(t); }).emulateTransitionEnd(a); }
else this._hideModal();
}
}
}, e.dispose = function() { [ window, this._element, this._dialog ].forEach(function(t) { return o.default(t).off('.bs.modal'); }), o.default(document).off('focusin.bs.modal'), o.default.removeData(this._element, 'bs.modal'), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null; }, e.handleUpdate = function() { this._adjustDialog(); }, e._getConfig = function(t) { return t = r({}, R, t), d.typeCheckConfig('modal', t, L), t; }, e._triggerBackdropTransition = function() {
 const t = this; if (this._config.backdrop === 'static') { const e = o.default.Event('hidePrevented.bs.modal'); if (o.default(this._element).trigger(e), e.isDefaultPrevented()) return; const n = this._element.scrollHeight > document.documentElement.clientHeight; n || (this._element.style.overflowY = 'hidden'), this._element.classList.add('modal-static'); const i = d.getTransitionDurationFromElement(this._dialog); o.default(this._element).off(d.TRANSITION_END), o.default(this._element).one(d.TRANSITION_END, function() { t._element.classList.remove('modal-static'), n || o.default(t._element).one(d.TRANSITION_END, function() { t._element.style.overflowY = ''; }).emulateTransitionEnd(t._element, i); }).emulateTransitionEnd(i), this._element.focus(); }
else this.hide();
}, e._showElement = function(t) {
 const e = this; const n = o.default(this._element).hasClass('fade'); const i = this._dialog ? this._dialog.querySelector('.modal-body') : null; this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = 'block', this._element.removeAttribute('aria-hidden'), this._element.setAttribute('aria-modal', !0), this._element.setAttribute('role', 'dialog'), o.default(this._dialog).hasClass('modal-dialog-scrollable') && i ? i.scrollTop = 0 : this._element.scrollTop = 0, n && d.reflow(this._element), o.default(this._element).addClass('show'), this._config.focus && this._enforceFocus(); const a = o.default.Event('shown.bs.modal', { relatedTarget: t }); const s = function() { e._config.focus && e._element.focus(), e._isTransitioning = !1, o.default(e._element).trigger(a); }; if (n) { const l = d.getTransitionDurationFromElement(this._dialog); o.default(this._dialog).one(d.TRANSITION_END, s).emulateTransitionEnd(l); }
else s();
}, e._enforceFocus = function() { const t = this; o.default(document).off('focusin.bs.modal').on('focusin.bs.modal', function(e) { document !== e.target && t._element !== e.target && o.default(t._element).has(e.target).length === 0 && t._element.focus(); }); }, e._setEscapeEvent = function() { const t = this; this._isShown ? o.default(this._element).on('keydown.dismiss.bs.modal', function(e) { t._config.keyboard && e.which === 27 ? (e.preventDefault(), t.hide()) : t._config.keyboard || e.which !== 27 || t._triggerBackdropTransition(); }) : this._isShown || o.default(this._element).off('keydown.dismiss.bs.modal'); }, e._setResizeEvent = function() { const t = this; this._isShown ? o.default(window).on('resize.bs.modal', function(e) { return t.handleUpdate(e); }) : o.default(window).off('resize.bs.modal'); }, e._hideModal = function() { const t = this; this._element.style.display = 'none', this._element.setAttribute('aria-hidden', !0), this._element.removeAttribute('aria-modal'), this._element.removeAttribute('role'), this._isTransitioning = !1, this._showBackdrop(function() { o.default(document.body).removeClass('modal-open'), t._resetAdjustments(), t._resetScrollbar(), o.default(t._element).trigger('hidden.bs.modal'); }); }, e._removeBackdrop = function() { this._backdrop && (o.default(this._backdrop).remove(), this._backdrop = null); }, e._showBackdrop = function(t) {
 const e = this; const n = o.default(this._element).hasClass('fade') ? 'fade' : ''; if (this._isShown && this._config.backdrop) { if (this._backdrop = document.createElement('div'), this._backdrop.className = 'modal-backdrop', n && this._backdrop.classList.add(n), o.default(this._backdrop).appendTo(document.body), o.default(this._element).on('click.dismiss.bs.modal', function(t) { e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && e._triggerBackdropTransition(); }), n && d.reflow(this._backdrop), o.default(this._backdrop).addClass('show'), !t) return; if (!n) return void t(); const i = d.getTransitionDurationFromElement(this._backdrop); o.default(this._backdrop).one(d.TRANSITION_END, t).emulateTransitionEnd(i); }
else if (!this._isShown && this._backdrop) {
 o.default(this._backdrop).removeClass('show'); const a = function() { e._removeBackdrop(), t && t(); }; if (o.default(this._element).hasClass('fade')) { const s = d.getTransitionDurationFromElement(this._backdrop); o.default(this._backdrop).one(d.TRANSITION_END, a).emulateTransitionEnd(s); }
else a();
}
else t && t();
 ...
 if (this._isEnabled) {
if (t) { const e = this.constructor.DATA_KEY; let n = o.default(t.currentTarget).data(e); n || (n = new this.constructor(t.currentTarget, this._getDelegateConfig()), o.default(t.currentTarget).data(e, n)), n._activeTrigger.click = !n._activeTrigger.click, n._isWithActiveTrigger() ? n._enter(null, n) : n._leave(null, n); }
else { if (o.default(this.getTipElement()).hasClass('show')) return void this._leave(null, this); this._enter(null, this); }
}
}, e.dispose = function() { clearTimeout(this._timeout), o.default.removeData(this.element, this.constructor.DATA_KEY), o.default(this.element).off(this.constructor.EVENT_KEY), o.default(this.element).closest('.modal').off('hide.bs.modal', this._hideModalHandler), this.tip && o.default(this.tip).remove(), this._isEnabled = null, this._timeout = null, this._hoverState = null, this._activeTrigger = null, this._popper && this._popper.destroy(), this._popper = null, this.element = null, this.config = null, this.tip = null; }, e.show = function() {
 const t = this; if (o.default(this.element).css('display') === 'none') throw new Error('Please use show on visible elements'); const e = o.default.Event(this.constructor.Event.SHOW); if (this.isWithContent() && this._isEnabled) {
 o.default(this.element).trigger(e); const n = d.findShadowRoot(this.element); const i = o.default.contains(n !== null ? n : this.element.ownerDocument.documentElement, this.element); if (e.isDefaultPrevented() || !i) return; const s = this.getTipElement(); const l = d.getUID(this.constructor.NAME); s.setAttribute('id', l), this.element.setAttribute('aria-describedby', l), this.setContent(), this.config.animation && o.default(s).addClass('fade'); const r = typeof this.config.placement === 'function' ? this.config.placement.call(this, s, this.element) : this.config.placement; const u = this._getAttachment(r); this.addAttachmentClass(u); const f = this._getContainer(); o.default(s).data(this.constructor.DATA_KEY, this), o.default.contains(this.element.ownerDocument.documentElement, this.tip) || o.default(s).appendTo(f), o.default(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new a.default(this.element, s, this._getPopperConfig(u)), o.default(s).addClass('show'), 'ontouchstart' in document.documentElement && o.default(document.body).children().on('mouseover', null, o.default.noop); const c = function() { t.config.animation && t._fixTransition(); const e = t._hoverState; t._hoverState = null, o.default(t.element).trigger(t.constructor.Event.SHOWN), e === 'out' && t._leave(null, t); }; if (o.default(this.tip).hasClass('fade')) { const h = d.getTransitionDurationFromElement(this.tip); o.default(this.tip).one(d.TRANSITION_END, c).emulateTransitionEnd(h); }
else c();
}
}, e.hide = function(t) {
 const e = this; const n = this.getTipElement(); const i = o.default.Event(this.constructor.Event.HIDE); const a = function() { e._hoverState !== 'show' && n.parentNode && n.parentNode.removeChild(n), e._cleanTipClass(), e.element.removeAttribute('aria-describedby'), o.default(e.element).trigger(e.constructor.Event.HIDDEN), e._popper !== null && e._popper.destroy(), t && t(); }; if (o.default(this.element).trigger(i), !i.isDefaultPrevented()) {
...
}, e._activate = function(t) { this._activeTarget = t, this._clear(); const e = this._selector.split(',').map(function(e) { return e + '[data-target="' + t + '"],' + e + '[href="' + t + '"]'; }); const n = o.default([].slice.call(document.querySelectorAll(e.join(',')))); n.hasClass('dropdown-item') ? (n.closest('.dropdown').find('.dropdown-toggle').addClass('active'), n.addClass('active')) : (n.addClass('active'), n.parents('.nav, .list-group').prev('.nav-link, .list-group-item').addClass('active'), n.parents('.nav, .list-group').prev('.nav-item').children('.nav-link').addClass('active')), o.default(this._scrollElement).trigger('activate.bs.scrollspy', { relatedTarget: t }); }, e._clear = function() { [].slice.call(document.querySelectorAll(this._selector)).filter(function(t) { return t.classList.contains('active'); }).forEach(function(t) { return t.classList.remove('active'); }); }, t._jQueryInterface = function(e) { return this.each(function() { let n = o.default(this).data('bs.scrollspy'); if (n || (n = new t(this, typeof e === 'object' && e), o.default(this).data('bs.scrollspy', n)), typeof e === 'string') { if (typeof n[e] === 'undefined') throw new TypeError('No method named "' + e + '"'); n[e](); } }); }, l(t, null, [ { key: 'VERSION', get() { return '4.5.3'; } }, { key: 'Default', get() { return lt; } } ]), t;
}()); o.default(window).on('load.bs.scrollspy.data-api', function() { for (let t = [].slice.call(document.querySelectorAll('[data-spy="scroll"]')), e = t.length; e--;) { const n = o.default(t[e]); ut._jQueryInterface.call(n, n.data()); } }), o.default.fn[at] = ut._jQueryInterface, o.default.fn[at].Constructor = ut, o.default.fn[at].noConflict = function() { return o.default.fn[at] = st, ut._jQueryInterface; }; const dt = o.default.fn.tab; const ft = (function() {
 function t(t) { this._element = t; } const e = t.prototype; return e.show = function() { const t = this; if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && o.default(this._element).hasClass('active') || o.default(this._element).hasClass('disabled'))) { let e; let n; const i = o.default(this._element).closest('.nav, .list-group')[0]; const a = d.getSelectorFromElement(this._element); if (i) { const s = i.nodeName === 'UL' || i.nodeName === 'OL' ? '> li > .active' : '.active'; n = (n = o.default.makeArray(o.default(i).find(s)))[n.length - 1]; } const l = o.default.Event('hide.bs.tab', { relatedTarget: this._element }); const r = o.default.Event('show.bs.tab', { relatedTarget: n }); if (n && o.default(n).trigger(l), o.default(this._element).trigger(r), !r.isDefaultPrevented() && !l.isDefaultPrevented()) { a && (e = document.querySelector(a)), this._activate(this._element, i); const u = function() { const e = o.default.Event('hidden.bs.tab', { relatedTarget: t._element }); const i = o.default.Event('shown.bs.tab', { relatedTarget: n }); o.default(n).trigger(e), o.default(t._element).trigger(i); }; e ? this._activate(e, e.parentNode, u) : u(); } } }, e.dispose = function() { o.default.removeData(this._element, 'bs.tab'), this._element = null; }, e._activate = function(t, e, n) {
 const i = this; const a = (!e || e.nodeName !== 'UL' && e.nodeName !== 'OL' ? o.default(e).children('.active') : o.default(e).find('> li > .active'))[0]; const s = n && a && o.default(a).hasClass('fade'); const l = function() { return i._transitionComplete(t, a, n); }; if (a && s) { const r = d.getTransitionDurationFromElement(a); o.default(a).removeClass('show').one(d.TRANSITION_END, l).emulateTransitionEnd(r); }
else l();
}, e._transitionComplete = function(t, e, n) { if (e) { o.default(e).removeClass('active'); const i = o.default(e.parentNode).find('> .dropdown-menu .active')[0]; i && o.default(i).removeClass('active'), e.getAttribute('role') === 'tab' && e.setAttribute('aria-selected', !1); } if (o.default(t).addClass('active'), t.getAttribute('role') === 'tab' && t.setAttribute('aria-selected', !0), d.reflow(t), t.classList.contains('fade') && t.classList.add('show'), t.parentNode && o.default(t.parentNode).hasClass('dropdown-menu')) { const a = o.default(t).closest('.dropdown')[0]; if (a) { const s = [].slice.call(a.querySelectorAll('.dropdown-toggle')); o.default(s).addClass('active'); }t.setAttribute('aria-expanded', !0); }n && n(); }, t._jQueryInterface = function(e) { return this.each(function() { const n = o.default(this); let i = n.data('bs.tab'); if (i || (i = new t(this), n.data('bs.tab', i)), typeof e === 'string') { if (typeof i[e] === 'undefined') throw new TypeError('No method named "' + e + '"'); i[e](); } }); }, l(t, null, [ { key: 'VERSION', get() { return '4.5.3'; } } ]), t;
}()); o.default(document).on('click.bs.tab.data-api', '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) { t.preventDefault(), ft._jQueryInterface.call(o.default(this), 'show'); }), o.default.fn.tab = ft._jQueryInterface, o.default.fn.tab.Constructor = ft, o.default.fn.tab.noConflict = function() { return o.default.fn.tab = dt, ft._jQueryInterface; }; const ct = o.default.fn.toast; const ht = { animation: 'boolean', autohide: 'boolean', delay: 'number' }; const gt = { animation: !0, autohide: !0, delay: 500 }; const mt = (function() {
 ...
 const t = this; const e = o.default.Event('show.bs.toast'); if (o.default(this._element).trigger(e), !e.isDefaultPrevented()) {
 this._clearTimeout(), this._config.animation && this._element.classList.add('fade'); const n = function() { t._element.classList.remove('showing'), t._element.classList.add('show'), o.default(t._element).trigger('shown.bs.toast'), t._config.autohide && (t._timeout = setTimeout(function() { t.hide(); }, t._config.delay)); }; if (this._element.classList.remove('hide'), d.reflow(this._element), this._element.classList.add('showing'), this._config.animation) { const i = d.getTransitionDurationFromElement(this._element); o.default(this._element).one(d.TRANSITION_END, n).emulateTransitionEnd(i); }
else n();
}
 ...
 const t = this; const e = function() { t._element.classList.add('hide'), o.default(t._element).trigger('hidden.bs.toast'); }; if (this._element.classList.remove('show'), this._config.animation) { const n = d.getTransitionDurationFromElement(this._element); o.default(this._element).one(d.TRANSITION_END, e).emulateTransitionEnd(n); }
else e();
}, e._clearTimeout = function() { clearTimeout(this._timeout), this._timeout = null; }, t._jQueryInterface = function(e) { return this.each(function() { const n = o.default(this); let i = n.data('bs.toast'); if (i || (i = new t(this, typeof e === 'object' && e), n.data('bs.toast', i)), typeof e === 'string') { if (typeof i[e] === 'undefined') throw new TypeError('No method named "' + e + '"'); i[e](this); } }); }, l(t, null, [ { key: 'VERSION', get() { return '4.5.3'; } }, { key: 'DefaultType', get() { return ht; } }, { key: 'Default', get() { return gt; } } ]), t;
